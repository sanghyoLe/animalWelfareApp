...
public class FreestallCalfWindBlock extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView freestall_protocol_2 = view.findViewById(R.id.breed_protocol_2);
        calfWindBlockRg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(viewModel.getSummerRestScore() == 0){
                    ...
                    protocolTwoScore = viewModelMilk.calculatorProtocolTwoScore(
                            viewModelMilk.getFreestallRestScore(),
                            totalWarmVen
                    );
                    freestall_protocol_2.setText(String.valueOf(protocolTwoScore));
                }
            }
        });
        return view;
